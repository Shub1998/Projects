...
<body>
    ...
    <div class="container-fluid">
     <div class ="row">
         <div class="col-sm-4"><p style="margin-left:20px;float:left;font-size:20px">Home Team : <b><% =value %></b> </p></div>
        <div class="col-sm-4"><p style="text-align:center;font-size:20px;"><b>MATCH <% =(Convert.ToInt32(DateTime.Now.ToString("dd"))-17)-1 %></b></p></div>
       ...
       <div class="col-sm-3">
            <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    <table style="width:500px;padding:10px;margin-left:2%" class="table" border="2">
                                        <thead>
                                            <tr style="color: white; background-color: #6e7bd9;">
                                            <th>Matches</th>
                                            <th>Teams</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>Match 1</td>
                                                <td>The FRONTLINE VS Others</td>
                                            </tr>
                                            <tr>
                                                <td>Match 2</td>
                                                <td>Perfect Strikers VS Others</td>
                                            </tr>
                                            <tr >
                                                <td>Match 3</td>
                                                <td>Conquerors VS Others</td>
                                            </tr>
                                            <tr >
                                                <td >Match 4</td>
                                                <td>Immortal CAT VS Others</td>
                                            </tr>
                                            <tr class="highlight">
                                                <td>Match 5</td>
                                                <td>DOVE VS Others</td>
                                            </tr>
                                             <tr>
                                                <td>Match 6</td>
                                                <td>Improvements</td>
          ...
          <div class="col-sm-5">
           <div class="col-xm-12" style="float:right;margin-right:2%">
                 ...
                 <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <div class="row">
                              ...
                              <div class="col-md-4">
                                  <asp:TextBox class="form-control" ID="TextBox1" runat="server" placeholder="Give Your Valueable Feedback" TextMode="MultiLine" Height="100" Width="470"></asp:TextBox>
                              </div>
                          </div>
                          <div class="row">
                              <div class ="col-md-4"></div>
                              <div class="col-md-4">
                              <asp:TextBox class="form-control" ID="TextBox2" type="password" runat="server" placeholder="Enter Score"></asp:TextBox>
                                  </div>
